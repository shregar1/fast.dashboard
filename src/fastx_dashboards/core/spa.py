...
`fastx_dashboards/static/`. When included in the composite dashboard router
...
<pre><code>cd fastx_dashboards/frontend && npm install && npm run build</code></pre>
<p>This will emit static assets to <code>fastx_dashboards/src/fastx_dashboards/static/</code>.</p>
</body></html>
"""
