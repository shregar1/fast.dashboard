...
Metabase appearance is often fragment-based; see :class:`~fastx_dashboards.providers.metabase.MetabaseEmbedProvider`.
"""
...
from fastx_dashboards.core.constants import QUERY_PARAM_LOCALE, QUERY_PARAM_THEME
...
class EmbedThemeParams:
    ...
    Pass into :func:`fastx_dashboards.embed_signing.sign_embed_url` via ``extra_params``
