"""Grafana dashboard URL helper with :mod:`fastx_dashboards.embed_signing` for optional signed query params.
...
signed together with ``exp`` / ``sig`` when passed to :func:`~fastx_dashboards.embed_signing.sign_embed_url`.
"""
...
from fastx_dashboards.core.constants import GRAFANA_EMBED_PATH_TEMPLATE
from fastx_dashboards.core.embed_signing import sign_embed_url
