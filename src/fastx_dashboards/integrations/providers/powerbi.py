...
class PowerBIEmbedProvider:
    """Placeholder :class:`~fastx_dashboards.providers.base.DashboardEmbedProvider` implementation.
    ...
    def build_embed_url(self, *, resource_id: str, ttl_seconds: int) -> str:
        ...
        raise NotImplementedError(
            "Power BI requires GenerateToken via REST API; see fastx_dashboards README (Power BI)."
        )
