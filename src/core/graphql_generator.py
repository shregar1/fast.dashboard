        ...
        # Try dataclass
            ...
            for name, field_info in model_class.__dataclass_fields__.items():
                ...
                fields.append(GraphQLField(
                    ...
                    type=gql_type,
                    required=required,
                    description=getattr(field_info, 'metadata', {}).get('description', '')
                ))
            ...
            if hasattr(route, 'methods') and hasattr(route, 'path'):
                ...
                for method in methods:
                    ...
                    for param_name, param in sig.parameters.items():
                        ...
                        if hasattr(param_type, '__name__') and not param.default == inspect.Parameter.empty:
    ...
    def _create_strawberry_schema(self):
        ...
        try:
            ...
            for type_name, type_def in self.schema_generator.types.items():
                ...
                strawberry_type = strawberry.type(type(type_name, (), {
